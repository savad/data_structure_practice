...
cho 1 danh sách N tasks, từ 0->N-1, mỗi task có thể depend vào 1 hay nhiều task khác.nhóm các task này lại thành một list các nhóm sao cho:
...
# [[4, 6], [3, 4], [2, 3], [3, 5], [1, 2], [1, 3], [5, 6], [7, 2], [4, 1]]
#
